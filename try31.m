...
%% function  Assembling_KT_R
function [T_sys,R_sys]=T_R_sys_Dynamic(x_ele,sNode_q,Node,ncon,uabc,wabc,f0,q0,F_app,ax,ay,az,M_sys_con1,coef_damp,X,Xd,Xdd)
...
% dx_sys=tridiagonal_matrix_algorithm(-T_sys_con1,R_sys_con1);
...
%         Assembling
            ...
            [T_sys,R_sys]=T_R_sys_Dynamic(x_ele,sNode_q,Node,ncon,uabc,wabc,f0,q0,F_app,ax,ay,az,M_sys_con1,coef_damp,Xi,Xdi,Xddi);
